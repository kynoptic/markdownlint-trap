 ...
 * @type {Set<string>}
 */
const COMMAND_KEYWORDS = new Set(['npm', 'yarn', 'git', 'docker', 'kubectl', 'curl', 'wget', 'ssh', 'scp', 'rsync', 'grep', 'sed', 'awk', 'find', 'ls', 'cd', 'mkdir', 'rm', 'cp', 'mv', 'chmod', 'chown', 'sudo', 'su', 'ps', 'top', 'htop', 'kill', 'killall', 'systemctl', 'service', 'crontab', 'tar', 'gzip', 'zip', 'unzip', 'cat', 'head', 'tail', 'less', 'more', 'vim', 'nano', 'emacs', 'code', 'open', 'explorer', 'ping', 'traceroute', 'nslookup', 'dig', 'netstat', 'ss', 'iptables', 'ufw', 'tcpdump', 'wireshark', 'nmap', 'john', 'hashcat', 'hydra', 'metasploit', 'burp', 'owasp', 'nikto', 'sqlmap', 'aircrack', 'reaver']);

/**
 * Set of file extension keywords for efficient lookup
 * @type {Set<string>}
 */
const FILE_EXTENSION_KEYWORDS = new Set(['js', 'ts', 'jsx', 'tsx', 'py', 'java', 'c', 'cpp', 'cs', 'go', 'rs', 'rb', 'php', 'pl', 'sh', 'bash', 'zsh', 'fish', 'ps1', 'bat', 'cmd', 'sql', 'html', 'css', 'scss', 'sass', 'less', 'xml', 'json', 'yaml', 'yml', 'toml', 'ini', 'cfg', 'conf', 'config', 'env', 'gitignore', 'dockerignore', 'editorconfig', 'prettierrc', 'eslintrc', 'babelrc', 'tsconfigjson', 'packagejson', 'composerjson', 'gemfile', 'requirements.txt', 'pipfile', 'cargo.toml', 'go.mod', 'pom.xml', 'build.gradle', 'webpack.config.js', 'rollup.config.js', 'vite.config.js', 'next.config.js', 'nuxt.config.js', 'vue.config.js', 'angular.json', 'tsconfig.json', 'jest.config.js', 'cypress.json', 'playwright.config.js', 'storybook', 'readme.md', 'changelog.md', 'license', 'contributing.md', 'code_of_conduct.md', 'security.md', 'pull_request_template.md', 'issue_template.md', 'funding.yml', 'dependabot.yml', 'codeql.yml', 'ci.yml', 'cd.yml', 'deploy.yml', 'release.yml', 'test.yml', 'build.yml', 'lint.yml', 'format.yml', 'security.yml', 'audit.yml', 'update.yml', 'backup.yml', 'restore.yml', 'migrate.yml', 'seed.yml', 'rollback.yml', 'status.yml', 'health.yml', 'monitor.yml', 'alert.yml', 'log.yml', 'trace.yml', 'debug.yml', 'profile.yml', 'benchmark.yml', 'load.yml', 'stress.yml', 'smoke.yml', 'integration.yml', 'unit.yml', 'e2e.yml', 'acceptance.yml', 'contract.yml', 'mutation.yml', 'property.yml', 'snapshot.yml', 'visual.yml', 'accessibility.yml', 'performance.yml', 'compliance.yml', 'governance.yml', 'risk.yml', 'review.yml', 'approval.yml', 'merge.yml', 'conflict.yml', 'rebase.yml', 'cherry-pick.yml', 'tag.yml', 'branch.yml', 'commit.yml', 'push.yml', 'pull.yml', 'fetch.yml', 'clone.yml', 'fork.yml', 'star.yml', 'watch.yml', 'follow.yml', 'sponsor.yml', 'donate.yml', 'support.yml', 'contact.yml', 'feedback.yml', 'report.yml', 'request.yml', 'suggestion.yml', 'idea.yml', 'proposal.yml', 'rfc.yml', 'adr.yml', 'decision.yml', 'meeting.yml', 'agenda.yml', 'minutes.yml', 'action.yml', 'task.yml', 'todo.yml', 'done.yml', 'progress.yml', 'news.yml', 'announcement.yml', 'version.yml', 'migration.yml', 'upgrade.yml', 'downgrade.yml', 'patch.yml', 'hotfix.yml', 'bugfix.yml', 'feature.yml', 'enhancement.yml', 'improvement.yml', 'optimization.yml', 'refactor.yml', 'cleanup.yml', 'maintenance.yml', 'deprecation.yml', 'removal.yml', 'addition.yml', 'modification.yml', 'change.yml', 'fix.yml', 'repair.yml', 'recover.yml', 'archive.yml', 'export.yml', 'import.yml', 'sync.yml', 'transfer.yml', 'copy.yml', 'move.yml', 'delete.yml', 'remove.yml', 'purge.yml', 'clean.yml', 'clear.yml', 'reset.yml', 'restart.yml', 'reload.yml', 'refresh.yml', 'renew.yml', 'regenerate.yml', 'rebuild.yml', 'recreate.yml', 'redeploy.yml', 'republish.yml', 'reprocess.yml', 'rerun.yml', 'retry.yml', 'resume.yml', 'pause.yml', 'stop.yml', 'start.yml', 'enable.yml', 'disable.yml', 'activate.yml', 'deactivate.yml', 'install.yml', 'uninstall.yml', 'setup.yml', 'configure.yml', 'initialize.yml', 'finalize.yml', 'complete.yml', 'finish.yml', 'end.yml', 'close.yml', 'launch.yml', 'execute.yml', 'run.yml', 'invoke.yml', 'call.yml', 'trigger.yml', 'schedule.yml', 'queue.yml', 'process.yml', 'handle.yml', 'manage.yml', 'control.yml', 'observe.yml', 'track.yml', 'measure.yml', 'analyze.yml', 'evaluate.yml', 'assess.yml', 'validate.yml', 'verify.yml', 'confirm.yml', 'approve.yml', 'reject.yml', 'accept.yml', 'decline.yml', 'allow.yml', 'deny.yml', 'grant.yml', 'revoke.yml', 'assign.yml', 'unassign.yml', 'allocate.yml', 'deallocate.yml', 'reserve.yml', 'release.yml', 'lock.yml', 'unlock.yml', 'secure.yml', 'unsecure.yml', 'protect.yml', 'unprotect.yml', 'encrypt.yml', 'decrypt.yml', 'sign.yml', 'authenticate.yml', 'authorize.yml', 'login.yml', 'logout.yml', 'signin.yml', 'signout.yml', 'register.yml', 'unregister.yml', 'subscribe.yml', 'unsubscribe.yml', 'join.yml', 'leave.yml', 'enter.yml', 'exit.yml', 'connect.yml', 'disconnect.yml', 'link.yml', 'unlink.yml', 'bind.yml', 'unbind.yml', 'attach.yml', 'detach.yml', 'mount.yml', 'unmount.yml', 'load.yml', 'unload.yml', 'save.yml', 'persist.yml', 'store.yml', 'retrieve.yml', 'fetch.yml', 'get.yml', 'set.yml', 'put.yml', 'post.yml', 'patch.yml', 'head.yml', 'options.yml', 'trace.yml']);

/**
 * Common English words that are rarely appropriate for backticks
 * @type {string[]}
 */
const COMMON_WORDS = ['i', 'a', 'an', 'the', 'and', 'or', 'but', 'in', 'on', 'at', 'to', 'for', 'of', 'with', 'by', 'is', 'are', 'was', 'were', 'be', 'been', 'being', 'have', 'has', 'had', 'do', 'does', 'did', 'will', 'would', 'could', 'should', 'may', 'might', 'can', 'must', 'shall', 'this', 'that', 'these', 'those', 'here', 'there', 'where', 'when', 'why', 'how', 'all', 'any', 'some', 'many', 'much', 'few', 'little', 'most', 'more', 'less', 'one', 'two', 'three', 'first', 'last', 'next', 'previous', 'before', 'after'];

/**
 * Natural language phrases that should not be wrapped in backticks
 * @type {string[]}
 */
const NATURAL_LANGUAGE_PHRASES = ['read/write', 'pass/fail', 'on/off', 'in/out', 'up/down', 'left/right', 'true/false', 'yes/no', 'black/white', 'day/night', 'hot/cold', 'big/small', 'fast/slow', 'high/low', 'old/new', 'start/stop', 'begin/end', 'open/close', 'save/load', 'push/pull', 'give/take', 'buy/sell', 'win/lose', 'love/hate', 'good/bad', 'right/wrong', 'rich/poor', 'male/female', 'young/old', 'early/late', 'easy/hard', 'safe/dangerous'];

/**
 * Regex patterns that commonly cause false positives for code detection
 * @type {RegExp[]}
 */
const PROBLEMATIC_PATTERNS = [/^[a-z]{1,3}$/,
 ...
 * @type {string[]}
 */
const NATURAL_LANGUAGE_INDICATORS = ['is a', 'are a', 'was a', 'were a', 'this is', 'that is', 'it is', 'he is', 'she is', 'would be', 'could be', 'should be', 'might be', 'must be', 'i think', 'i believe', 'in my opinion', 'personally', 'generally', 'for example', 'such as', 'like this', 'as follows', 'namely', 'however', 'therefore', 'moreover', 'furthermore', 'nevertheless', 'note that', 'remember that', 'keep in mind', 'be aware', 'make sure'];

/**
 * Technical context indicators that suggest code content
 * @type {string[]}
 */
const TECHNICAL_INDICATORS = ['install', 'configure', 'setup', 'deploy', 'build', 'compile', 'run', 'execute', 'command', 'script', 'function', 'method', 'class', 'variable', 'parameter', 'api', 'endpoint', 'request', 'response', 'server', 'client', 'database', 'repository', 'branch', 'commit', 'merge', 'push', 'pull', 'clone', 'fork'];
...
function analyzeCodeVsNaturalLanguage(text, context = {}) {
  ...
  const strongCodeIndicators = [new RegExp(`\\.(${Array.from(FILE_EXTENSION_KEYWORDS).join('|')})$`, 'i'), /^[A-Z_][A-Z0-9_]*$/,
