...
var _default = exports.default = {
  ...
  function rule(params, onError) {
    ...
    const validationResult = (0, _configValidation.validateConfig)(config, configSchema, 'wt/no-bare-urls');
    if (!validationResult.isValid) {
      (0, _configValidation.logValidationErrors)('wt/no-bare-urls', validationResult.errors);
