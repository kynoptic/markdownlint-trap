...
exports.knownDirectoryPrefixes = exports.commonConceptualWords = exports.casingTerms = exports.backtickIgnoredTerms = exports.ampersandDefaultExceptions = exports.ambiguousTerms = exports.UPPERCASE_WORD_REGEX = exports.UNICODE_UPPERCASE_REGEX = exports.UNICODE_LETTER_REGEX = exports.EMOJI_REGEX = void 0;
// @ts-check
...
const EMOJI_REGEX = exports.EMOJI_REGEX = /[\u{1F1E0}-\u{1F1FF}\u{1F300}-\u{1F5FF}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F700}-\u{1F77F}\u{1F780}-\u{1F7FF}\u{1F800}-\u{1F8FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\u{1F900}-\u{1F9FF}\u{1FA00}-\u{1FA6F}\u{1FA70}-\u{1FAFF}\u{1F000}-\u{1F02F}\u{1F0A0}-\u{1F0FF}\u{1F100}-\u{1F1FF}\u{1F3FB}-\u{1F3FF}\u200D\uFE0F]/u;