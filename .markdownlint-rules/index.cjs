...
var _noBareUrls = _interopRequireDefault(require("./rules/no-bare-urls.cjs"));
 ...
 */
var _default = exports.default = [_backtickCodeElements.default, _sentenceCaseHeading.default, _noBareUrls.default, _noDeadInternalLinks.default, _noLiteralAmpersand.default];
