 ...
 * const markdownlintConfig = require("markdownlint-trap/markdownlint-absolute");
 *
...
const sentenceCase = require(path.join(
  projectRoot,
  "rules",
  "sentence-case.js"
));
const backtickCodeElements = require(path.join(
  projectRoot,
  "rules",
