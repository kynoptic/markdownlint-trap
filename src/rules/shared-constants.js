...
/**
 * GitHub alert keywords that appear in all-caps in headings (e.g., `[!NOTE]`).
 * Shared between case-classifier and fix-builder to keep the two in sync.
 */
export const contextualAllCapsTerms = new Set(['note', 'tip', 'important', 'warning', 'caution']);
